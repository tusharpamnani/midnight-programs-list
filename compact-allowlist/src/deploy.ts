...
// Shared utilities
// compiledContract is pre-built with stub witnesses — correct for deployment
// (the proof server does not invoke witnesses during deployContract).
import {
  createWallet,
  createProviders,
  compiledContract,
...
async function main() {
  ...
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log('║        Deploy ZK Allowlist to Midnight Preprod                ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    // compiledContract already carries stub witnesses: no ZK proof is generated
    // during deployment so the stubs are never actually invoked.
